...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "cau_no" -parent ${Page_0}
...
proc update_PARAM_VALUE.cau_no { PARAM_VALUE.cau_no } {
	# Procedure called to update cau_no when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cau_no { PARAM_VALUE.cau_no } {
	# Procedure called to validate cau_no
	return true
}
...
proc update_MODELPARAM_VALUE.cau_no { MODELPARAM_VALUE.cau_no PARAM_VALUE.cau_no } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cau_no}] ${MODELPARAM_VALUE.cau_no}
}
